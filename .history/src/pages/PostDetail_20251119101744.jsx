...
export default function PostDetail() {
	...
	useEffect(() => {
		if (!post || !post.authorId) {
			// don't set state synchronously -> avoids React warning
			return;
		}
	...
	const handleAuthorClick = () => {
		...
		// Later swap to /user/:id when you add public profiles.
		navigate('/account');
	};
							...
							<div className="author-popup-card">
								<div className="author-popup-header">
									...
									<div className="author-popup-main">
										<div className="author-popup-name">
											{displayName}
										</div>
										{authorRole && (
											<div className="author-popup-role">
												{authorRole}
											</div>
										)}
									</div>
