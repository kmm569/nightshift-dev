...
export default function UserProfile() {
	...
	const avatarUrl =
		profile.avatarUrl || profile.photoURL || profile.photoUrl || null;
				...
				<div className="account-body">
					<div className="account-section">
						...
						<p className="account-bio">
							{profile.bio || "This nightshift dev has not written a bio yet."}
						</p>
					</div>
					...
					<div className="account-section account-grid">
						...
						<div className="account-field">
							...
							<span className="value">{role || "Member"}</span>
						</div>
					</div>
					...
					<div className="account-section">
						...
						{!github && !website && !twitter && !linkedin && (
							<p className="account-mini">No social links added yet.</p>
						)}
					...
					<div className="account-section">
						<h2>Posts</h2>
						{loadingPosts ? (
							<p className="account-mini">Loading posts…</p>
						) : posts.length === 0 ? (
							<p className="account-mini">No posts from this user yet.</p>
						) : (
								...
								{posts.map((post) => {
									...
									return (
										...
										>
											...
											{dateText && (
												<span className="user-post-date">{dateText}</span>
											)}
										</button>
									);
								})}
					...
					<div className="account-section muted">
						<p>
							This is a public profile view. Edit your own info from the Account
							page when signed in.
						</p>
					</div>
				</div>
